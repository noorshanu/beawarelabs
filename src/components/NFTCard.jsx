  ...
  return (
    <div className="rounded-lg bg-[#212121]  ">
      ...
      <div className="p-2 space-y-1">
        ...
        <button className="rounded-full text-[0.8rem] font-bold border-2 border-[#fdb913] text-[#fdb913] bg-[#0088ff00]  w-full flex justify-center items-center py-1.5">
          Enter Now
        </button>
        <p className="text-[11px] mt-1 font-extrabold text-gray-400 text-center ">
