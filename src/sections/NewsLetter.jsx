        ...
        <div className="flex flex-col items-center text-center px-[60px] py-[90px] mx-auto my-0 max-w-[1440px]">
            ...
            <p className="font-[16px] text-[#313131] text-center  mt-0 mx-0 mb-7">
                ...
                <form action="" className="flex text-left ant-form gap-5">
                    ...
                    <button type="button" className="text-white bg-[#212121] hover:bg-[#fdd46e] hover:text-black sm:w-[150px] w-[300px] h-12 flex justify-center items-center font-[600] text-[15px] rounded-md border-0  ">Subscribe</button>
                </form>
        </div>
    </section>
  )
